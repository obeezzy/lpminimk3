...
class TestButtonMatch(unittest.TestCase):
    ...
    def test_panel_contains_match_press(self):
        ...
        self.assertTrue(match.contains([0xb0, 0x5b, 0xff]), 'No button matched.')  # noqa

        match = ButtonMatch(self.lp.panel.buttons('up', 'down', 'left'), ButtonEvent.PRESS)  # noqa
        self.assertTrue(match.contains([0xb0, 0x5b, 0xff]), 'No button matched.')  # noqa
        self.assertTrue(match.contains([0xb0, 0x5c, 0xff]), 'No button matched.')  # noqa
        self.assertTrue(match.contains([0xb0, 0x5d, 0xff]), 'No button matched.')  # noqa

        self.assertFalse(match.contains([0xb0, 0x5d, 0x0]), 'Button matched, though it shouldn\'t.')  # noqa
        self.assertFalse(match.contains([0xb0, 0x5e, 0xff]), 'Button matched, though it shouldn\'t.')  # noqa
    ...
    def test_panel_contains_match_release(self):
        ...
        self.assertFalse(match.contains([0xb0, 0x5d, 0xff]), 'Button matched, though it shouldn\'t.')  # noqa
    ...
    def test_grid_contains_match_press(self):
        ...
        self.assertTrue(match.contains([0x90, 0x51, 0xff]), 'No button matched.')  # noqa

        match = ButtonMatch(self.lp.panel.buttons('0x0', '1x0', '2x0'), ButtonEvent.PRESS)  # noqa
        self.assertTrue(match.contains([0x90, 0x51, 0xff]), 'No button matched.')  # noqa
        self.assertTrue(match.contains([0x90, 0x52, 0xff]), 'No button matched.')  # noqa
        self.assertTrue(match.contains([0x90, 0x53, 0xff]), 'No button matched.')  # noqa

        self.assertFalse(match.contains([0x90, 0x53, 0x0]), 'Button matched, though it shouldn\'t.')  # noqa
        self.assertFalse(match.contains([0x90, 0x54, 0xff]), 'Button matched, though it shouldn\'t.')  # noqa
    ...
    def test_grid_contains_match_release(self):
        ...
        self.assertFalse(match.contains([0x90, 0x53, 0xff]), 'Button matched, though it shouldn\'t.')  # noqa
